function [results parametersOut] = Form(func, parameters, correlations, settings, arg)
%
...
%
    if logger == 1
        fprintf(fileID, [' iloop ' num2str(nmaal) ' itmax ' num2str(iterm) ' relaxf ' num2str(relaxf) '\n']);
    end

% Startwaarden copieren     
    u = Uopt;
    [itsom, inorde, alfan, beta, gemZ, Pf, sigZ, x, u, z] = ...
    ItProc(func, iterm, itsom, nstoch, parameters, trmH, relaxf, ...
    u, epsB, epsZ, fileID, arg);
%
